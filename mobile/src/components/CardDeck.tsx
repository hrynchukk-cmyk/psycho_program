...
const styles = StyleSheet.create({
  ...
  progressBar: { height: 5, borderRadius: 3, backgroundColor: colors.brandSoftBorder, overflow: 'hidden' },
  ...
  navBtn: { paddingVertical: 12, paddingHorizontal: 18, borderRadius: 12, borderWidth: 1, borderColor: colors.border, backgroundColor: colors.cream },
  navDisabled: { opacity: 0.4 },
  navText: { fontSize: 14, fontWeight: '600', color: colors.text2 },
  navBtnPrimary: { paddingVertical: 12, paddingHorizontal: 22, borderRadius: 12, backgroundColor: colors.brandDark },
  navTextPrimary: { fontSize: 14, fontWeight: '700', color: colors.goldText },
  ...
  btn: { backgroundColor: colors.brandDark, borderRadius: 12, paddingVertical: 12, paddingHorizontal: 32 },
  btnText: { color: colors.goldText, fontSize: 15, fontWeight: '700' },
})
