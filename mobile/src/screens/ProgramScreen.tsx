...
const styles = StyleSheet.create({
  ...
  section: { fontSize: 11, fontWeight: '700', color: colors.eyebrow, textTransform: 'uppercase', marginBottom: 10, letterSpacing: 1 },
  stepRow: { flexDirection: 'row', gap: 10 },
  stepContent: { flex: 1, flexDirection: 'row', alignItems: 'center', gap: 8, paddingTop: 1 },
  stepChevron: { fontSize: 20, color: colors.faint },
