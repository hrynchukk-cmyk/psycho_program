    ...
    <div>
      <div className="mb-5 flex flex-wrap items-center justify-between gap-3">
        <div>
          ...
          <p className="mt-1 text-sm text-gray-500">Запишіть пацієнта на прийом за пару кліків</p>
        </div>
      ...
      <p className="mt-3 text-xs text-gray-400">
        Натисніть на вільне місце в сітці, щоб записати пацієнта на цей час, або на запис — щоб змінити.
      </p>
